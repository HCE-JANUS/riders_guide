...
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="css/guide.css"/>
#+HTML_HEAD: <script type="text/javascript" src="js/guide.js"></script>

#+ATTR_HTML: :width 90px :align right
[[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/HCE.svg]]
...
[[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/HCE_Van.jpg]]
...
# Add a bullet here each time a section below changes: date, a link to the
# section, and a short note on what changed. Newest entry on top. This
# comment isn't exported; only the list below is.
#+begin_recentupdates
- *2026-09-14* — [[Hours of Operation and Holidays][Hours of Operation and Holidays]] updated with the 2027 holiday service schedule.
- *2026-09-14* — New [[Hamilton County Express Service Area][Hamilton County Express Service Area]] connection point: One-Call Connect, a CIRTA-administered pilot service linking Hamilton and Hancock counties.
- *2026-09-08* — New [[Policy: Multi-Step Rides][Policy: Multi-Step Rides]]: HCE will schedule trips from an origin to a destination and back, but not trips that add a third stop before returning home.
- *2026-09-08* — Guide redesigned for in-app viewing: new table of contents, readable code/quote formatting, and pages that fit the screen inside the HCE Rides app.
#+end_recentupdates
...
- *Holidays with no operation:* HCE is always closed on the following holidays: New Years Day (January 1), Independence Day (July 4), Memorial Day (variable), Labor Day (variable), Thanksgiving (variable), and Christmas Day (December 25). These holidays are sometimes extended to two or three days, as shown in the table below. 
  ...
  Holiday Schedule for 2026-2027:
  ...
  | New Years        | Thursday | 12/31/2026 | /No Service/  |
  | New Years        | Friday   | 1/1/2027   | /No Service/  |
  | New Years        | Saturday | 1/2/2027   | /No Service/  |
  | Memorial Day     | Monday   | 5/31/2027  | /No Service/  |
  | Independence Day | Monday   | 7/5/2027   | /No Service/  |
  | Labor Day        | Monday   | 9/6/2027   | /No Service/  |
  | Thanksgiving     | Thursday | 11/25/2027 | /No Service/  |
  | Thanksgiving     | Friday   | 11/26/2027 | /No Service/  |
  | Thanksgiving     | Saturday | 11/27/2027 | /No Service/  |
  | Christmas Eve    | Friday   | 12/24/2027 | /No Service/  |
  | Christmas Day    | Saturday | 12/25/2027 | /No Service/  |
...
#+NAME: *Figure 1:*
#+ATTR_HTML: :width 360px
[[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig01.png]]
...
- *Boone County* - Boone Area Transit Service (BATS) ([[https://www.cirta.us/county-connect/transportation-resources/boone-area-transit-service][BATS web site]]). +1 (765) 482-5220. HCE provides service
...
- *Madison Co.* - Transportation for Rural Areas of Madison Co. (TRAM) ([[https://www.cirta.us/county-connect/transportation-resources/tram/][TRAM web site]]). +1 (855) 743-3843. HCE provides service connections to and from the following (TRAM) connecting location in Pendleton:
  + *Loves Travel Stop* 9000 Interpark Dr., Pendleton, IN 46064
- *Hancock County* - One-Call Connect ([[file:one-call-connect.html][One-Call Connect web site]]), a pilot service administered by CIRTA, coordinating trips between an address in Hamilton County and an address in Hancock County. HCE and RIDE Hancock vehicles transfer riders at:
  + *Leo's Market and Eatery* 8956 N 600 W, McCordsville, IN 46055

  Cost is $8.00 per trip (covers both legs, one-way; round trip is $16). All bookings, cancellations, and trip changes must go through CIRTA directly at +1 (317) 327-7433 — HCE dispatch cannot make these changes.
...
#+begin_tip
HCE provides telephone translation services for most languages, including Spanish, French, and Arabic, upon request.
#+end_tip
...
* Scheduling Rides
Hamilton County Express is an /on-demand/ transit service. On-demand means that rather than going to a bus stop at a fixed time to catch the bus, you must schedule each leg of your trip, as well as provide a schedule for your trips. Because HCE is also a shared ride service, it’s important to understand a key distinction — Arrive By versus Leave At.

#+begin_important
Here is an explanation of the Arrive By versus Leave At distinction:
- *Arrive By:* This is the */latest/* time that the bus can */drop you off./* So, if you need to be at work by 9:00 AM, you should schedule the trip as Arrive By, say, 8:55 AM. Arrive By constrains your drop-off time. The bus is not on time if it drops you after 8:55 AM. This is the leaving home schedule. You don’t want the bus to drop you off after your shift begins or your appointment time starts.
...
#+begin_warning
*Here’s where you could go wrong:* You know that it takes about 20 minutes to go from your house to work, and you want to be at work at 9:00, so you schedule the bus to Leave At 8:40 AM. If you schedule the ride as Leave At 8:40 AM, however, you have /absolutely/ no guarantee that you will get to work by 9:00 AM. In fact, there is no guarantee that the bus will even pick you up before 9:00 AM. All you’ve told the Spare Engine — HCE's scheduling software — is /not/ to pick you up before 8:40 AM, so it would generate a pickup window of 8:40 AM to 9:10 AM, and you'd be notified of that window through your chosen notification method.
#+end_warning
...
#+begin_warning
*Trips with a third stop before you return home* — for example, home to school, then school to work, then work back home — are constrained on /both/ sides for the middle leg: the pickup can't happen before the previous stop lets out, and the drop-off has to happen before the next commitment starts. HCE cannot guarantee on-time performance for legs like that. See [[Policy: Multi-Step Rides][Policy: Multi-Step Rides]] below.
#+end_warning
...
You can schedule trips yourself using the HCE Rides app without having to call Hamilton County Express reservations. Rides must be scheduled at least two hours prior to pickup. Follow these steps:
     *1. Open the HCE Rides App.*
       The home screen opens with your current location, as shown in Figure 2.
        ...
        #+NAME: *Figure 2:
        #+ATTR_HTML: :width 360px
	[[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig02.png]]
    ...
    *2. Type your /destination/ into the Where To search box.*
       ...
       #+NAME: Figure 3:
       #+ATTR_HTML: :width 360px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig03.png]]
       ...
       #+NAME: Figure 4:
       #+ATTR_HTML: :width 360px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig04.png]]
    ...
    *3. If the default pickup location is correct, then click the Set As Pickup button.*
       ...
       #+NAME: Figure 5:
       #+ATTR_HTML: :width 360px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig05.png]]
    ...
    *4. Click and review the four buttons above the Select Hamilton County Express button.*
       ...
       #+NAME: Figure 6:
       #+ATTR_HTML: :width 360px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig06.png]]

       #+CAPTION: The eWallet option shows your balance before you book a trip. 
       #+NAME: Figure 7:
       #+ATTR_HTML: :width 360px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig07.png]]
    ...
    *5. After you confirm the four buttons, click Select Hamilton County Express Service.*
	...
	The Confirm Trip Details screen appears, as shown in Figure 8.
       ...
       #+NAME: Figure 8:
       #+ATTR_HTML: :width 360px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig08.png]]
    ...
    *6. Click the Schedule Ride button.*
	...
	You will see a confirmation of your ride, as shown in Figure 9.
       ...
       #+CAPTION: If you don't see a ride with [driver name] (left), then your ride is in unmatched status, meaning that you don't yet have the ride, but we're working on it.
       #+NAME: Figure 9:
       #+ATTR_HTML: :width 800px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig09.png]]
...
To move the pin, click the Set on map option, and then drag the map as shown in Figure 10.
       ...
       #+NAME: Figure 10:
       #+ATTR_HTML: :width 360px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig10.png]]
...
#+begin_tip
      Sometimes the best way to communicate with the driver is by adding a pickup note, where you can give information such as a particular door or entry code, as shown below.
       ...
       #+ATTR_HTML: :width 360px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfigtip01.png]]
#+end_tip
...
You can add a favorite location any time you choose a destination. Just tap the heart symbol by the location, as shown in Figure 11.
       ...
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig11.png]]
 ...
 If you want to delete a favorite location, follow these steps:
    1. Tap on the profile circle at the top left of the Where To screen to open your profile, as shown in Figure 12.
       ...
       #+NAME: Figure 12:
       #+ATTR_HTML: :width 180px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig12.png]]
    ...
    5. Tap the Delete Favorite Location button, as shown in Figure 13.
       ...
       #+NAME: Figure 13:
       #+ATTR_HTML: :width 360px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig13.png]]
 ...
 You can also change the icon of any favorite in the same screen shown below:
       ...
       #+ATTR_HTML: :width 360px
       [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfigtip02.png]]
...
Hamilton County Express is a shared-ride transportation service. Our goal is to provide as many rides as possible to as many riders as possible, while still getting everyone to their destinations on time. Per Federal Transit Administration rules, all shared-ride services must provide pickup windows, as follows:
- *Pickup window:* A 30-minute window for the vehicle, calculated for each trip by the Spare Engine — the same scheduling software that builds and updates HCE's routes (see above).
...
As an example, for an 8:00 AM pick-up, the bus arrival window will begin at 7:55 AM and end at 8:25 AM. This is the time period when you can expect the bus to arrive at your location. All trips are considered On Time when bus arrival is within the 30-minute pick-up window. Spare notifies you of your pickup window through whichever notification method you selected when you set up your account — text message, phone call, email, or the HCE Rides app. See the following section, Getting Ride Notifications, for details on each method and to find out how you are notified of your bus’s precise estimated time of arrival.
...
#+begin_warning
Any time that a text fails to reach your phone for any reason (such as the phone being turned off or being out of range of a tower), Spare turns off your text messages until HCE office personnel turn them back on. If you feel like you aren't getting the text messages you should be receiving, call Dispatch, and we can turn them back on for you.
#+end_warning
...
On Android, go to Settings > Notifications > Advanced Settings > Notification History. Toggle the Use Notification History setting to on. This allows you to view the notification history, as shown in Figure 14.
  ...
  #+NAME: Figure 14:
  #+ATTR_HTML: :width 360px
  [[https://raw.githubusercontent.com/HCE-JANUS/riders_guide/main/img/rgfig14.png]]
...
~The bus was dirty and stank of cigarette smoke. The driver was afflicted with road rage, cursed at other vehicles, and traded rude gestures with other drivers. The driver drove over the speed limit, didn’t signal for turns — which were often taken on two wheels — blew through stop signs, and slammed on the brakes while tailgating, throwing me violently forward in my seat multiple times. Even so, I was still ten minutes late for work. 0/10: I’d rather hike through a blizzard barefoot.~
...
- Reasonable Accommodations: The following are accommodations that HCE can make for passengers with special needs:
  + *Door-to-door driver assistance:* HCE service is /curb-to-curb/ (origin to destination), but drivers can assist all passengers who require it onto and off the vehicles. /Door-to-door service/ (assistance provided by the driver to and from the bus) is available upon request to the driver, customer service, or dispatch for those needing reasonable assistance (arm holding, guiding visually impaired riders, pushing a wheelchair, and so on) to or from the doorway of their home/building main entrance and bus. 
  ...
  + *Mobility equipment supported by HCE:* Wheelchairs, electric wheelchairs, mobility scooters, walkers, lift access, portable oxygen tanks, and canes. HCE maintains a fleet of minivans that require ramp access. Contact Dispatch at +1 (317) 776-3226 if you may have difficulty negotiating the ramp access due to use of a walker.
...
HCE will not operate in areas where city-wide emergencies have been declared. HCE reserves the right not to operate on certain roads if it is felt to be unsafe for passengers and drivers. Riders will be informed of the emergency and its possible effects on their schedules via the notification system.
...
Because of the high demand for service and to ensure that service is generally not detrimentally impacted, HCE is not responsible for the return of items lost or left on the bus to riders after the driver has left the rider’s immediate area.
Riders can contact the HCE Dispatch Office at +1 (317) 776-3226 during normal business hours to report a lost item and make plans to retrieve their lost property.
Any items in Lost and Found not claimed after 30 days may be discarded at the discretion of Hamilton County Express.

** Policy: Multi-Step Rides
HCE customer service will help you schedule trips from an origin to a destination and back to that same origin (for example, home to work and then back home). They will not schedule trips that go to a third location before returning home.

You can create trips like that yourself using the HCE Rides app, but because those trips are constrained on both sides, HCE will not be responsible for those rides not arriving on time or arriving to pick you up too early.

You can call dispatch and attempt to change the destination of your current ride — for example, asking to be dropped at the drug store near your home instead of at home itself — but HCE is not then responsible for the ride from the drug store to your home. You can attempt to schedule that as a new ride through the app or by calling, but your original ride is complete once you're dropped off.

#+begin_warning
*Example:* You get out of school at 3:00 PM and need to be at work by 3:30 PM. That leg is constrained on both ends — it can't leave school before 3:00 PM, and it must arrive at work by 3:30 PM — leaving no room for the shared-ride pickup windows Hamilton County Express relies on. Trips like this are not guaranteed to run on time.
#+end_warning
...
A personal care attendant (PCA) is welcome to accompany a passenger at no charge. All PCAs must be able to provide the assistance required of the rider, without the assistance of the driver. Please inform HCE about your attendant at the time that you schedule the trip.
...
Subscription trips (also known as /recurring trips/) are ongoing trips scheduled on a recurring basis (daily, weekly, and so on). These trips accommodate such purposes as employment, school, day services, regular medical appointments (for example, dialysis appointments and the like). Subscription trips allow a rider’s trips to be automatically created by the system to avoid the necessity of creating repeated, identical trips.

Before being considered for an HCE subscription, applicants must be riders in good standing on HCE for at least ninety (90) days, have kept their account current, and have zero or few no-shows and late cancellations. Subscription trips are subject to availability and must be requested by submitting a Subscription Trip Request Form at least 30 days in advance of the first requested pickup date.
...
- HCE has a 30-minute arrival window for pickup, generated by the Spare Engine and sent to you via your chosen notification method (see [[Understanding Pickup Windows][Understanding Pickup Windows]]).
...
- If the HCE vehicle has not arrived within your pick-up window, call +1 (317) 776-3226.
...
For more information on the Janus Developmental Services, Inc. dba Hamilton County Express's civil rights program, and the procedures to file a complaint, contact +1 (317) 773-8781, (TTY +1 (800) 743-3333); bplatz@janus-inc.org; or visit our administrative office at 1555 Westfield Road, Noblesville, IN 46062. For more information, visit our [[https://www.janus-inc.org/transportation-services][web site]].

A complainant may file a complaint directly with the Federal Transit Administration by filing a complaint with the Office of Civil Rights, Attention: Title VI Program Coordinator, East Building, 5th Floor-TCR, 1200 New Jersey Ave., SE Washington, DC, 20590.

** Disclosure: Transportation Advisory Committee
The purpose of the Transportation Advisory Committee is to provide HCE with recommendations regarding transportation policies and procedures; to advise HCE on transportation service changes; and, to provide a forum in which the public can raise concerns and propose solutions for improving public transportation service in Hamilton County. Committee meetings are open to the public. For meeting information, please call +1 (317) 773-8781, xt113 and ask to speak with the Senior Transportation Manager or visit our  [[https://janus-inc.org/transportation-services][web site]].

2026 Advisory Committee Meeting Dates (Location: 1555 Westfield Road, Noblesville, IN 46062):
...
+1 (317) 773-8781	[[https://www.janus-inc.org/transportation-services][Janus website]]
